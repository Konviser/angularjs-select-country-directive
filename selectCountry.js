...
angular.module('selectCountry')
    ...
    var linkFunc = function(scope,elem,attrs){
    	...
    	var idElem = (!!attrs.id)? ' id='+attrs.id+' ': '';
    	var nameElem = (!!attrs.name)? ' name='+attrs.name+' ': '';
    	var ngModel = (!!attrs.ngModel)? ' ng-model='+attrs.ngModel+' ': '';

			var html = '<select class="form-control"' + idElem + nameElem + ngModel
